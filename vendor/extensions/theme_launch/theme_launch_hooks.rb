class ThemeLaunchHooks < Spree::ThemeSupport::HookListener
#  remove :sidebar
#  insert_before :head, 'product/styles'


#  insert_after :product_description do
#    '<p>Audiophile Oasis&copy; All Rights Reserved.  </p><p> Disclaimer text </p>'
#  end
